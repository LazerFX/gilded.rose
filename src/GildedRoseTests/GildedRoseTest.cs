...
namespace GildedRoseTests
{
    public class GildedRoseTest
    {
        ...
        [InlineData("stuff", -1, -1, -2, 0)]
        [InlineData($"{KeyValues.ConjuredPrefix}stuff", 1, 10, 0, 8)]
        [InlineData($"{KeyValues.ConjuredPrefix}stuff", 2, 10, 1, 8)]
        [InlineData($"{KeyValues.ConjuredPrefix}stuff", 0, 10, -1, 6)]
        [InlineData($"{KeyValues.ConjuredPrefix}stuff", -1, 1, -2, 0)]
        [InlineData($"{KeyValues.ConjuredPrefix}stuff", -1, 0, -2, 0)]
        [InlineData($"{KeyValues.ConjuredPrefix}stuff", -1, -1, -2, 0)]
